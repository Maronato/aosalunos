...
from misago.utils.avatars import resizeimage, save_avatar_s3
...
def upload(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            image_path_s3 = settings.MEDIA_ROOT_S3 + 'avatars/' + image_name
            request.user.avatar_temp = image_name

            # create file locally and on S3
            ...
            try:
                ...
                # saves to s3
                save_avatar_s3(image_path + request.user.avatar_original)
