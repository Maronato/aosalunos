...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InfoCookie'
        db.create_table(u'app_infocookie', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('c_value', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ))
        db.send_create_signal(u'app', ['InfoCookie'])


    def backwards(self, orm):
        # Deleting model 'InfoCookie'
        db.delete_table(u'app_infocookie')


    models = {
        u'app.infocookie': {
            'Meta': {'object_name': 'InfoCookie'},
            'c_value': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
