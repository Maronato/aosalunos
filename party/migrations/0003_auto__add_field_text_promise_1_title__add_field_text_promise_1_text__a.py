...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Text.promise_1_title'
        db.add_column(u'party_text', 'promise_1_title',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Text.promise_1_text'
        db.add_column(u'party_text', 'promise_1_text',
                      self.gf('django.db.models.fields.TextField')(default=' ', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Text.promise_2_title'
        db.add_column(u'party_text', 'promise_2_title',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Text.promise_2_text'
        db.add_column(u'party_text', 'promise_2_text',
                      self.gf('django.db.models.fields.TextField')(default=' ', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Text.promise_1_title'
        db.delete_column(u'party_text', 'promise_1_title')

        # Deleting field 'Text.promise_1_text'
        db.delete_column(u'party_text', 'promise_1_text')

        # Deleting field 'Text.promise_2_title'
        db.delete_column(u'party_text', 'promise_2_title')

        # Deleting field 'Text.promise_2_text'
        db.delete_column(u'party_text', 'promise_2_text')
    ...
    models = {
        ...
        u'party.text': {
            ...
            'promise_1_text': ('django.db.models.fields.TextField', [], {'default': "' '", 'null': 'True', 'blank': 'True'}),
            'promise_1_title': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'promise_2_text': ('django.db.models.fields.TextField', [], {'default': "' '", 'null': 'True', 'blank': 'True'}),
            'promise_2_title': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
