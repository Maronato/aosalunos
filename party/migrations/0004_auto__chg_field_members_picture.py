...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Members.picture'
        db.alter_column(u'party_members', 'picture', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Members.picture'
        db.alter_column(u'party_members', 'picture', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'party.members': {
            ...
            'picture': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
